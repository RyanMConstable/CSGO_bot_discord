...
def findusertop(steamid):
    ...
    userStats.append(['Unique Messages:' , str(CSGOsql.findTop1user('uniquemsgs', steamid))])
    head = ["Category", "Best"]
    return [userStats, head]



#Average function formatting for a single user
def findAvg(id, limiter):
    ...
    strVal.append(["Enemy Flash Duration", round(CSGOsql.selectAvgUserStat("enemyflashduration", id, limiter),2)])
...
def findSum(id, limiter):
    ...
    strVal.append(["Team Flash Duration", round(CSGOsql.selectSumUserStat("teamflashduration", id, limiter),2)])
    strVal.append(["Enemy Flash Duration", round(CSGOsql.selectSumUserStat("enemyflashduration", id, limiter),2)])
...
def posGame(userID):
    ...
    tableInfo.append(["Team Flash Duration", CSGOsql.findPos(userID, "teamflashduration")])
    tableInfo.append(["Enemy Flash Duration", CSGOsql.findPos(userID, "enemyflashduration")])
    tableInfo.append(["Unique Messages", CSGOsql.findPos(userID, "uniquemsgs")])
