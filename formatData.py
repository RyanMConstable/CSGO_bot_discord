...
def findAvg(id, limiter = None):
    ...
    strVal.append(["Assists", round(CSGOsql.selectAvgUserStat("assist", id),2)])
    strVal.append(["Deaths", round(CSGOsql.selectAvgUserStat("deaths", id),2)])
    strVal.append(["Headshots", round(CSGOsql.selectAvgUserStat("headshot", id),2)])
    strVal.append(["KD", round(CSGOsql.selectAvgUserStat("kd", id),2)])
    strVal.append(["RWS", round(CSGOsql.selectAvgUserStat("rws", id),2)])
    strVal.append(["Shot Count", round(CSGOsql.selectAvgUserStat("shot_count", id),2)])
    strVal.append(["Hit Count", round(CSGOsql.selectAvgUserStat("hit_count", id),2)])
    strVal.append(["ADR", round(CSGOsql.selectAvgUserStat("adr", id),2)])
    strVal.append(["Entry Frags", round(CSGOsql.selectAvgUserStat("entry_kill_won_count", id),2)])
    strVal.append(["Entry Deaths", round(CSGOsql.selectAvgUserStat("entry_kill_loss_count", id),2)])
    strVal.append(["Total Damage", round(CSGOsql.selectAvgUserStat("total_health_damage", id),2)])
    strVal.append(["Total Damage Taken", round(CSGOsql.selectAvgUserStat("total_health_damage_taken", id),2)])
    strVal.append(["Kills Per Round", round(CSGOsql.selectAvgUserStat("kill_per_round", id),2)])
    strVal.append(["Assists Per Round", round(CSGOsql.selectAvgUserStat("assist_per_round", id),2)])
    strVal.append(["Deaths Per Round", round(CSGOsql.selectAvgUserStat("death_per_round", id),2)])
