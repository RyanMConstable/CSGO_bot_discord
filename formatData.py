...
def findusertop(steamid):
    ...
    userStats.append(['Entry Denied:' , str(CSGOsql.findTop1user('entry_hold_kill_won_count', steamid))])
    ...
    userStats.append(['Armor Damage: ' , str(CSGOsql.findTop1user('total_armor_damage', steamid))])
    userStats.append(['Damage Taken: ' , str(CSGOsql.findTop1user('total_health_damage_taken', steamid))])
    ...
    userStats.append(['Avg Death Tm:' , str(CSGOsql.findTop1user('avg_time_death', steamid))])
